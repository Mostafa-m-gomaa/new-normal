...
const PostCard = ({ post, date, isBlog }) => {
  ...
  return (
    <>
      ...
      <div className="bg-blackGold p-4 my-4 rounded-2xl">
        ...
        <div>
          ...
          >
            <input
              ...
              className="rounded-full bg-main p-2 px-4 pb-3 w-full"
          ...
          <div className="max-h-[800px] overflow-y-auto">
            ...
            {!gotComments && (
              <button
                className="bg-main block px-6 py-2 rounded-lg w-fit mx-auto "
                onClick={() => {
                  if (!gotComments) {
                    setGotComments(true);
                    getComments();
        ...
        <Link
          to={`/${isBlog ? "blog" : "dashboard"}/post-details/${post._id}`}
          className="mt-4 bg-main block px-6 py-2 rounded-lg w-fit mx-auto "
        >
          تفاصيل البوست
        </Link>
      </div>
