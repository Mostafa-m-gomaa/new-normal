...
const MarketingForm = () => {
  ...
  return (
    <div className="p-6 bg-main rounded-2xl border border-gray m-6 sm:m-12">
      <h2 className="font-semibold text-center text-xl">
        سجل كشريك نجاح وضاعف ارباحك
      </h2>
      ...
      <form className="space-y-4" onSubmit={(e) => onSubmit(e)}>
        ...
        <button
          type="submit"
          className="font-semibold text-mainText bg-main px-10 py-2 rounded-xl mx-auto block w-fit"
        >
          سجل
        </button>
      </form>
